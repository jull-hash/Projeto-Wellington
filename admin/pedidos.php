...
$sqluser="SELECT * FROM usuario ORDER BY id_usuario";
$sql="SELECT * FROM pedido ORDER BY id_pedido";
$user= mysqli_query($conexao, $sql);
$userinfo= mysqli_query($conexao, $sql);
?>
      ...
      <table>
        ...
        <tbody>
          <tr>
            ...
            $i = mysqli_fetch_assoc($userinfo)    ?>
            <td style="font-weight: 700;"><?php echo $u["id_pedido"]; ?></td>
